#!/usr/bin/env python3
"""Phase1 -> Phase3 handoff for the soil2.

Triggered by systemd timer. It checks Phase1 state once and exits.
When Phase1 has completed, it stops water-test-soil2.service, sends a pump-off
fallback to esp32/pump2/cmd, then starts phase3_soil2.service.
"""
...
STATE_PATH = Path("/root/water/phase1_test/phase1_data_soil2.json")
PHASE3_PARAMS = Path("/root/water/phase3/soil2/evolving_params.json")
LOCK_PATH = Path("/run/phase1_to_phase3_soil2.lock")
LOG_PATH = Path("/root/water/phase_handoff/phase1_to_phase3_soil2.log")

PHASE1_SERVICE = "water-test-soil2.service"
PHASE3_SERVICE = "phase3_soil2.service"
